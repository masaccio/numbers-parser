# From archived LLDB:
# https://github.com/llvm-mirror/lldb/blob/master/packages/Python/lldbsuite/test/lldbutil.py
#
...
def run_to_name_breakpoint(
    test, bkpt_name, launch_info=None, exe_name="a.out", bkpt_module=None, in_cwd=True
):
